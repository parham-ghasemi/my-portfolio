...
interface DemoComputerProps {
  texture?: string; // Optional string for the texture path
  [key: string]: any; // Allow additional props
}

const DemoComputer: React.FC<DemoComputerProps> = (props) => {
  const group = useRef<THREE.Group>(null); // Ensure group has the correct type
  // const { nodes, materials, animations } = useGLTF('/models/computer.glb') as unknown as {

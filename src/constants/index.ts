...
export const calculateSizes = (isSmall: boolean, isMobile: boolean, isTablet: boolean): {
  ...
  return {
    ...
    cubePosition: isSmall ? [4, -8, 5] : isMobile ? [5, -8, 5] : isTablet ? [5, -5, 5] : [9, -5.5, 5],
    reactLogoPosition: isSmall ? [3, 4, 0] : isMobile ? [5, 4, 0] : isTablet ? [8, 8, 0] : [18, 7, 0],
    ringPosition: isSmall ? [-5, 7, 0] : isMobile ? [-10, 7, 0] : isTablet ? [-12, 10, 0] : [-24, 10, 0],
    targetPosition: isSmall ? [-7, -5, -1] : isMobile ? [-9, -9, -1] : isTablet ? [-11, -7, -1] : [-13, -13, -1],
  };
};
